...
const languages = [
	...
	{ name: 'ipython', language: 'ipython', identifiers: ['ipython', 'ipython2', 'ipython3', '\\{\\.ipython.+?\\}'], source: 'source.python' },
...
const buildGrammar = () => {
	...
	fs.writeFileSync(path.join(__dirname, 'syntaxes', 'myst.tmLanguage'), out);
};
